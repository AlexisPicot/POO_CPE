...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies_plantuml_encoder: string;
	export const npm_package_dependencies_reveal_js: string;
	export const npm_package_dependencies_utf8_bytes: string;
	...
	export const npm_package_dependencies__types_plantuml_encoder: string;
	export const npm_package_dependencies__types_reveal_js: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies_plantuml_encoder: string;
		npm_package_dependencies_reveal_js: string;
		npm_package_dependencies_utf8_bytes: string;
		npm_package_dependencies__fontsource_jetbrains_mono: string;
		npm_package_dependencies__fontsource_manrope: string;
		npm_package_dependencies__types_plantuml_encoder: string;
		npm_package_dependencies__types_reveal_js: string;
